...
import com.can.cblog.base.enums.EGender;
import com.can.cblog.base.enums.ELinkStatus;
...
import com.can.cblog.web.global.MessageConf;
import com.can.cblog.web.global.RedisConf;
...
public class AuthRestApi {
    ...
    public String updateUserPwd(HttpServletRequest request, @RequestParam(value = "oldPwd") String oldPwd, @RequestParam("newPwd") String newPwd) {
        ...
        User user = userService.getById(userUid);
        // 判断是否是第三方登录的账号
        if (!user.getSource().equals(SysConf.CBLOG)) {
        ...
        switch (source) {
            case SysConf.GITHUB:
                authRequest = new AuthGithubRequest(AuthConfig.builder()
                        ...
                        .redirectUri(cblogWebUrl + "/oauth/callback/github")
                        .build());
                break;
            case SysConf.GITEE:
                authRequest = new AuthGiteeRequest(AuthConfig.builder()
                        ...
                        .redirectUri(cblogWebUrl + "/oauth/callback/gitee")
                        .build());
                break;
            case SysConf.QQ:
                authRequest = new AuthQqRequest(AuthConfig.builder()
                        ...
                        .redirectUri(cblogWebUrl + "/oauth/callback/qq")
                        .build());
                break;
            default:
                break;
