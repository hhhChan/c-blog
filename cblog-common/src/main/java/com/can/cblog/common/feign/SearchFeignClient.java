...
import com.can.cblog.common.fallback.SearchFeignFallback;
 ...
 * @author ccc
 */
@FeignClient(name = "cblog-search", contextId = "searchFeignClient", configuration = FeignConfiguration.class, fallback = SearchFeignFallback.class)
