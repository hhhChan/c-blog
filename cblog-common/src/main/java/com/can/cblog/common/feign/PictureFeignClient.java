...
import com.can.cblog.common.fallback.PictureFeignFallback;
 ...
 * @author ccc
 */
@FeignClient(name = "cblog-picture", configuration = FeignConfiguration.class, fallback = PictureFeignFallback.class)
