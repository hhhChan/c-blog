package com.can.cblog.picture.spider;
...
public class PictureProcesser implements PageProcessor {
    ...
    private static void add(List<String> localFile) throws QiniuException {
        for (String ss : localFile) {
            ...
            //生成上传凭证，然后准备上传
            String accessKey = "WlxBR_ILG6SlddTvJkwpoX8SI8qAhbr8M-cefiMi";
            String secretKey = "M_lLUiyrgSxi900UIITWstexhmjcL1vmrRIQEuiN";
            String bucket = "ccc-blog";
            //...其他参数参考类注释
