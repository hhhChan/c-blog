package com.can.cblog.picture.service.impl;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.can.cblog.base.enums.EFilePriority;
import com.can.cblog.base.enums.EOpenStatus;
import com.can.cblog.base.enums.EStatus;
import com.can.cblog.base.exception.exceptionType.InsertException;
...
import com.can.cblog.common.entity.File;
import com.can.cblog.common.entity.FileSort;
import com.can.cblog.common.entity.SystemConfig;
import com.can.cblog.picture.global.MessageConf;
import com.can.cblog.picture.global.SQLConf;
import com.can.cblog.picture.global.SysConf;
import com.can.cblog.picture.mapper.FileMapper;
import com.can.cblog.picture.service.*;
import com.can.cblog.picture.util.AboutFileUtil;
import com.can.cblog.picture.util.FeignUtil;
import com.can.cblog.utils.FileUtils;
...
public class FileServiceImpl extends SuperServiceImpl<FileMapper, File> implements FileService {
    ...
    public String batchUploadFile(HttpServletRequest request, List<MultipartFile> filedatas, SystemConfig systemConfig) {
        ...
        if (StringUtils.isEmpty(userUid) && StringUtils.isEmpty(adminUid)) {
            return ResultUtil.result(SysConf.ERROR, "请先登录");
        }
    ...
    public String uploadPictureByUrl(FileVO fileVO) {
        ...
        List<com.can.cblog.common.entity.File> lists = new ArrayList<>();
        //文件上传
        if (urlList != null && urlList.size() > 0) {
            for (String itemUrl : urlList) {
                ...
                com.can.cblog.common.entity.File file = new com.can.cblog.common.entity.File();
                file.setCreateTime(new Date(System.currentTimeMillis()));
                file.setFileSortUid(fileSort.getUid());
